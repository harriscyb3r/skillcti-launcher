    ...
    <div className="p-6 max-w-xl">
      ...
      <div className="mb-8">
        ...
        <div className="bg-surface border border-border rounded-lg shadow-card p-4">
          ...
          <div className="text-[10px] text-txt-3 mb-4">
            ...
            <div key={key}>
              <label className="text-[10px] font-semibold tracking-[0.08em] text-txt-2 block mb-[5px] uppercase">
                <span className="flex items-center gap-2">
                  {label}
                  {isConfigured && (
                    <span className="text-[8px] font-bold tracking-[0.08em] px-1.5 py-[2px] rounded border border-green/40 text-green leading-none">
                      CONFIGURED
                    </span>
                  )}
                </span>
              ...
              <div className="relative">
                ...
                {sensitive && (
                  <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 text-[9px] text-txt-3 hover:text-txt-2 font-bold uppercase tracking-wider bg-transparent border-none cursor-pointer"
                  >
                    {showKeys[key] ? 'Hide' : 'Show'}
                  </button>
                )}
              </div>
              <p className="text-[10px] text-txt-3 mt-1 leading-relaxed">
