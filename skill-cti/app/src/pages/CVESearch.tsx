  ...
  if (loading) {
    return (
      <div className="bg-surface border border-border rounded-lg shadow-card p-5 flex items-center gap-3">
        <div className="w-4 h-4 border-2 border-txt-3 border-t-transparent rounded-full animate-spin flex-shrink-0" />
        <span className="font-mono text-[13px] text-txt">{raw}</span>
        <span className="text-[11px] text-txt-3">Looking up NVD, EPSS, CISA KEV…</span>
      </div>
    )
  }
  ...
  return (
    <div className="bg-surface border border-border rounded-lg shadow-card overflow-hidden">
      <div className="flex flex-wrap items-center gap-2 px-5 py-4 border-b border-border">
        <span className="font-mono text-[13px] font-bold text-txt tracking-wide mr-1">
          {result.cve_id}
        </span>
        {cvss && (
          <span
            className="text-[9px] font-bold tracking-[0.15em] uppercase px-2 py-[3px] rounded font-mono"
        ...
        {epss && (
          <span
            className="text-[9px] font-bold tracking-[0.1em] uppercase px-2 py-[3px] rounded font-mono"
        ...
        <span className="ml-auto text-[9px] text-txt-3 font-mono">
      ...
      <div className="px-5 py-4 flex flex-col gap-4">
          ...
          <div>
            ...
            {result.description.length > descLimit && (
              <button
                ...
                className="text-[10px] text-txt-3 hover:text-txt-2 hover:underline bg-transparent border-none cursor-pointer mt-1 p-0"
              >
        ...
        {cvss?.vector && (
          <div className="flex items-center gap-2">
            <span className="text-[8px] font-bold tracking-[0.15em] text-txt-3 uppercase">
              CVSS v{cvss.version}
            </span>
            <span className="font-mono text-[9px] text-txt-3 break-all">{cvss.vector}</span>
          </div>
        )}
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1.5">
              {result.affected.map((p, i) => (
                <span
                  key={i}
                  className="text-[9px] font-mono bg-bg border border-border px-2 py-[3px] rounded text-txt-2"
                >
                  {p.vendor} · {p.product}
                </span>
              ))}
        ...
        {kev && (
          <div className="bg-bg border border-border rounded-lg p-3">
            <p className="text-[8px] font-bold tracking-[0.15em] text-red uppercase mb-2">
              CISA Known Exploited Vulnerability
            </p>
            <div className="grid grid-cols-2 gap-x-6 gap-y-1 text-[10px] mb-2">
              <div>
            ...
            {kev.required_action && (
              <p className="text-[10px] text-txt-2 italic leading-relaxed">{kev.required_action}</p>
            )}
          </div>
        )}
        ...
        <div className="pt-1 border-t border-border">
          <button
            ...
            className="flex items-center gap-2 text-[10px] font-bold tracking-[0.08em] text-txt-2 hover:text-txt transition-colors bg-transparent border-none cursor-pointer p-0 uppercase"
          >
  ...
  return (
    <div className="flex h-full overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-6">
        ...
        <h1 className="text-[22px] font-bold text-txt tracking-tight mb-1">CVE Search</h1>
