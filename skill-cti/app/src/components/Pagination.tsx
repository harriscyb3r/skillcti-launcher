    ...
    <div className="border-t border-border mt-1 pt-3 flex items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          disabled={!hasPrev}
          className="text-[10px] font-bold px-3 py-1.5 rounded border border-border text-txt-2 bg-transparent cursor-pointer disabled:opacity-30 hover:border-purple transition-colors"
        >
          Prev
        </button>
