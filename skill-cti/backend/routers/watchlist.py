...
WatchItemType = Literal["ioc", "cve", "vendor", "threat_actor"]
...
def _make_item(type_: str, value: str, label: str = "") -> dict[str, Any]:
    return {
        ...
        "last_checked": None,
        "last_state": None,
        "check_interval_hours": 24 if type_ == "vendor" else 12,
    }
...
async def force_check(item_id: str):
    ...
    import httpx
    from watchlist_checker import _check_ioc, _check_cve, _check_vendor, _check_threat_actor
