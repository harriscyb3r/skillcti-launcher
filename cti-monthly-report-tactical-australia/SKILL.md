...
Save as `cti-report-au-tactical-<YYYY-MM>.html` using Write. Confirm the saved path in one concluding sentence. Do NOT echo the HTML to chat — the file is the deliverable.
