...
_ALWAYS_WRITE = {"default_tlp", "geography", "misp_url"}
...
async def get_integrations():
    """Which optional API integrations are configured — boolean only, no key values."""
    return {
        ...
        "hybrid_analysis": bool(settings.hybrid_analysis_api_key),
        "hibp":            bool(settings.hibp_api_key),
        "otx":             bool(settings.otx_api_key),
        "proxycheck":      bool(settings.proxycheck_api_key),
